            ...
            <div class="row">
                            ...
                            <div class="product_big_images-top">
                                <div class="portfolio-full-image tab-content">
                                    <div role="tabpanel" class="tab-pane active product-image-position" id="img-tab-5">
                                        <a href="/assets/images/product/details/w1.jpg" class="img-poppu">
                                            <img src="/assets/images/product/details/w1.jpg" alt="#">
                                        </a>
                                    </div>
                ...
                <div class="col-xl-7 col-lg-6 col-md-6">
                    ...
                    <div class="product_details_info">
                        <h2>{{$product->getColumnByName('name')}}</h2>
                        <!-- pro_details start -->
                        ...
                        <ul class="pro_dtl_prize">
                            <li class="old_prize">${{$product->getColumnByName('price')}}</li>
                            <li> ${{$product->getColumnByName('price')-
                    $product->getColumnByName('price')*$product->getColumnByName('discount')/100}}</li>
                        </ul>
                        <!-- pro_dtl_prize end -->
                        ...
                        <div class="product_tab_content tab-pane active" id="description" role="tabpanel">
                            <div class="product_description_wrap">
                                <div class="product_desc mb--30">
                                    ...
                                    <p>{{$product->getColumnByName('description')}} (расширенное)</p>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Content -->
